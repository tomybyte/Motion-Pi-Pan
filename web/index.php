...
function pan_controls() {
	...
	if ($mode <> 0) {
		...
		echo '<div id="remotecontrol" class="container-fluid text-center liveimage remotecontrol">';
		echo '<div id="arrowUpLeft" onclick="servo_pipan(this.id);"></div>';
		echo '<div alt="Up" id="arrowUp" onclick="servo_pipan(this.id);"></div>';
		echo '<div id="arrowUpRight" onclick="servo_pipan(this.id);"></div>';
		echo '<div>';
		echo '<div alt="Left" id="arrowLeft" onclick="servo_pipan(this.id);"></div>';
		echo '<div id="arrowCenter" onclick="servo_pipan(this.id);"></div>';
		echo '<div alt="Right" id="arrowRight" onclick="servo_pipan(this.id);"></div>';
		echo '</div>';
		echo '<div id="arrowDownLeft" onclick="servo_pipan(this.id);"></div>';
		echo '<div alt="Down" id="arrowDown" onclick="servo_pipan(this.id);"></div>';
		echo '<div id="arrowDownRight" onclick="servo_pipan(this.id);"></div>';
		echo '</div>';
	} 
} 
...
<html>
   <head>
    ...
    <meta name='viewport' content='width=370,target-densityDpi=device-dpi'>
    <meta name='mobileoptimized' content='370'>
    <meta name='HandheldFriendly' content='true'>
	<link rel='icon' type='image/x-icon' href='/favicon.ico'>
	<link rel='shortcut icon' type='image/x-icon' href='/favicon.ico'>
      <title><?php echo CAM_STRING;
...
?>>
         <div class="container">
            <div class="navbar-header">
               <a class="navbar-brand" href="#"><?php echo CAM_STRING;
...
?> <?php if (file_exists("pipan_on")) echo "ontouchstart=\"pipan_start()\"";

?> onclick="toggle_fullscreen(this);" src="./loading.jpg"></div>
...
<?php
if (file_exists("pipan_on")) echo '<input id="motion_button" type="button" class="btn btn-primary">';
...
?> >
                        ...
                        <tr>
                           ...
                           <td>Load Preset: <select onchange="set_preset(this.value)">
								<?php if (!file_exists('uPresets.html')) : ?>
								 ...
								 <?php else : include 'uPresets.html';
	endif;

	?>
                              </select><br>
                              Custom Values:<br>
                              Video res: <?php makeInput('video_width', 4);

	?>x<?php makeInput('video_height', 4);

	?>px<br>
                              Video fps: <?php makeInput('video_fps', 2);

	?>recording, <?php makeInput('MP4Box_fps', 2);

	?>boxing<br>
                              Image res: <?php makeInput('image_width', 4);

	?>x<?php makeInput('image_height', 4);
	...
	?>px<br>
                        ...
                        <tr>
                           ...
                           <td>
                              Use camera: <select onchange="send_cmd('cn ' + this.value)"><?php makeOptions($options_cn, 'camera_num');
	...
	?>
                        <tr>
                           ...
                           <td><?php makeInput('tl_interval', 4);

	?>s <input type="button" value="OK" onclick="send_cmd('tv ' + 10 * document.getElementById('tl_interval').value)"></td>
                        </tr>
                        <tr>
                           <td>Video Split (seconds, default 0=off):</td>
                           <td><?php makeInput('video_split', 6);

	?>s <input type="button" value="OK" onclick="send_cmd('vi ' + document.getElementById('video_split').value)"></td>
                        </tr>
                        <tr>
	...
	?><input type="button" value="OK" onclick="send_cmd('an ' + encodeURI(document.getElementById('annotation').value))"><input type="button" value="Default" onclick="document.getElementById('annotation').value = 'RPi Cam %Y.%M.%D_%h:%m:%s'; send_cmd('an ' + encodeURI(document.getElementById('annotation').value))"><br>
                              Background: <select onchange="send_cmd('ab ' + this.value)"><?php makeOptions($options_ab, 'anno_background');
	...
	?><input type="button" value="OK" onclick="send_cmd('as ' + document.getElementById('anno_text_size').value)">
                           </td>
                        </tr>
                        <tr>
	...
	?></select>
                              y:u:v = <?php makeInput('at_y', 3, 'anno3_custom_text_Y');

	?>:<?php makeInput('at_u', 4, 'anno3_custom_text_U');

	?>:<?php makeInput('at_v', 4, 'anno3_custom_text_V');
	...
	?></select>
                              y:u:v = <?php makeInput('ac_y', 3, 'anno3_custom_background_Y');

	?>:<?php makeInput('ac_u', 4, 'anno3_custom_background_U');

	?>:<?php makeInput('ac_v', 4, 'anno3_custom_background_V');
	...
	?>
                        <tr>
                           ...
                           <td><?php makeInput('video_buffer', 4);

	?><input type="button" value="OK" onclick="send_cmd('bu ' + document.getElementById('video_buffer').value)"></td>
                        </tr>                        <tr>
                           <td>Sharpness (-100...100), default 0:</td>
                           <td><?php makeInput('sharpness', 4);

	?><input type="button" value="OK" onclick="send_cmd('sh ' + document.getElementById('sharpness').value)"></td>
                        </tr>
                        <tr>
                           <td>Contrast (-100...100), default 0:</td>
                           <td><?php makeInput('contrast', 4);

	?><input type="button" value="OK" onclick="send_cmd('co ' + document.getElementById('contrast').value)">
                           </td>
                        </tr>
                        <tr>
                           <td>Brightness (0...100), default 50:</td>
                           <td><?php makeInput('brightness', 4);

	?><input type="button" value="OK" onclick="send_cmd('br ' + document.getElementById('brightness').value)"></td>
                        </tr>
                        <tr>
                           <td>Saturation (-100...100), default 0:</td>
                           <td><?php makeInput('saturation', 4);

	?><input type="button" value="OK" onclick="send_cmd('sa ' + document.getElementById('saturation').value)"></td>
                        </tr>
                        <tr>
                           <td>ISO (100...800), default 0:</td>
                           <td><?php makeInput('iso', 4);

	?><input type="button" value="OK" onclick="send_cmd('is ' + document.getElementById('iso').value)"></td>
                        </tr>
                        <tr>
                           <td>Metering Mode, default 'average':</td>
                           <td><select onchange="send_cmd('mm ' + this.value)"><?php makeOptions($options_mm, 'metering_mode');

	?></select></td>
                        </tr>
                        <tr>
                           <td>Video Stabilisation, default: 'off'</td>
                           <td><select onchange="send_cmd('vs ' + this.value)"><?php makeOptions($options_vs, 'video_stabilisation');

	?></select></td>
                        </tr>
                        <tr>
                           <td>Exposure Compensation (-10...10), default 0:</td>
                           <td><?php makeInput('exposure_compensation', 4);

	?><input type="button" value="OK" onclick="send_cmd('ec ' + document.getElementById('exposure_compensation').value)"></td>
                        </tr>
                        <tr>
                           <td>Exposure Mode, default 'auto':</td>
                           <td><select onchange="send_cmd('em ' + this.value)"><?php makeOptions($options_em, 'exposure_mode');

	?></select></td>
                        </tr>
                        <tr>
                           <td>White Balance, default 'auto':</td>
                           <td><select onchange="send_cmd('wb ' + this.value)"><?php makeOptions($options_wb, 'white_balance');

	?></select></td>
                        </tr>
                        <tr>
                           <td>White Balance Gains (x100):</td>
                           <td> gain_r <?php makeInput('ag_r', 4, 'autowbgain_r');

	?> gain_b <?php makeInput('ag_b', 4, 'autowbgain_b');
	...
	?>
                        ...
                        <tr>
                           ...
                           <td><select onchange="send_cmd('ie ' + this.value)"><?php makeOptions($options_ie, 'image_effect');

	?></select></td>
                        </tr>
                        <tr>
                           <td>Colour Effect, default 'disabled':</td>
                           <td><select id="ce_en"><?php makeOptions($options_ce_en, 'colour_effect_en');

	?></select>
                              u:v = <?php makeInput('ce_u', 4, 'colour_effect_u');
	...
	?></select></td>
                        ...
                        <tr>
                           ...
                           <td>
                              x<?php makeInput('roi_x', 5, 'sensor_region_x');

	?> y<?php makeInput('roi_y', 5, 'sensor_region_y');

	?> w<?php makeInput('roi_w', 5, 'sensor_region_w');

	?> h<?php makeInput('roi_h', 4, 'sensor_region_h');
	...
	?> <input type="button" value="OK" onclick="set_roi();">
                        ...
                        <tr>
                           ...
                           <td><?php makeInput('shutter_speed', 4);

	?><input type="button" value="OK" onclick="send_cmd('ss ' + document.getElementById('shutter_speed').value)">
                           </td>
                        </tr>
                        <tr>
	...
	?><input type="button" value="OK" onclick="send_cmd('qu ' + document.getElementById('image_quality').value)">
                           </td>
                        </tr>
                        <tr>
	...
	?><input type="button" value="OK" onclick="send_cmd('bi ' + document.getElementById('video_bitrate').value)">
                           </td>
                        </tr>
                        <tr>
	...
	?></select></td>
                           ...
                           <td>Interval <?php makeInput('watchdog_interval', 3);

	?>s&nbsp;&nbsp;&nbsp;&nbsp;Errors <?php makeInput('watchdog_errors', 3);
	...
	?>
                        ...
                        <tr>
                           ...
                           <td><select onchange="send_cmd('mx ' + this.value);setTimeout(function(){location.reload(true);}, 1000);"><?php makeOptions($options_mx, 'motion_external');
	...
	?></select></td>
                        ...
                        <tr>
                           ...
                           <td>
                              <?php makeInput('log_size', 6);

	?><input type="button" value="OK" onclick="send_cmd('ls ' + document.getElementById('log_size').value)">
                           </td>
                        </tr>
                     </table>
                  </div>
                  ...
                  <div class="panel-body">
                     <table class="settingsTable">
                        <tr>
                          ...
                          <td>
                            <select onchange="send_cmd('vp ' + this.value);setTimeout(function(){location.reload(true);}, 1000);" id="preview_select"><?php makeOptions($options_vp, 'vector_preview');
	...
	?></select>
                        ...
                        <tr>
                           ...
                           <td>
                              <?php makeInput('motion_noise', 5);

	?><input type="button" value="OK" onclick="send_cmd('mn ' + document.getElementById('motion_noise').value)">
                           </td>
                        </tr>
                        <tr>
                           <td>Threshold (1-32000):</td>
                           <td>
                              <?php makeInput('motion_threshold', 5);

	?><input type="button" value="OK" onclick="send_cmd('mt ' + document.getElementById('motion_threshold').value)">
                           </td>
                        </tr>
                        <tr>
                           <td>Clipping factor (2-50) default 3:</td>
                           <td>
                              <?php makeInput('motion_clip', 5);

	?><input type="button" value="OK" onclick="send_cmd('mc ' + document.getElementById('motion_clip').value)">
                           </td>
                        </tr>
                        <tr>
                           <td>Mask Image:</td>
                           <td>
                              <?php makeInput('motion_image', 30);

	?><input type="button" value="OK" onclick="send_cmd('mi ' + document.getElementById('motion_image').value)">
                           </td>
                        </tr>
                        <tr>
                           <td>Change Frames to start:</td>
                           <td>
                              <?php makeInput('motion_startframes', 5);
	...
	?><input type="button" value="OK" onclick="send_cmd('mb ' + document.getElementById('motion_startframes').value)">
                        ...
                        <tr>
                           ...
                           <td>
                              <?php makeInput('motion_stopframes', 5);
	...
	?><input type="button" value="OK" onclick="send_cmd('me ' + document.getElementById('motion_stopframes').value)">
                        ...
                        <tr>
                           ...
                           <td><select onchange="send_cmd('mf ' + this.value);"><?php makeOptions($options_mf, 'motion_file');
