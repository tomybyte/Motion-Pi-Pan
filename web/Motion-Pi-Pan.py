...
#cam_to_x_divisor = 7 # for 76 degree camera
#cam_to_y_divisor = 6
cam_to_x_divisor = 4 # for 160 degree camera
cam_to_y_divisor = 5
...
def motion_track():
    ...
    cam_height, cam_width, cam_channels = img_frame.shape
            ...
            if face_center != () or motion_center != ():
                ...
                if servo_active == False:
                    if face_center != ():
                        ...
                        cy = motion_center[1]
                        source = 'motion'
                    Nav_LR = int((cam_cx - cx) / cam_to_x_divisor)
                    Nav_UD = int((cam_cy - cy) / cam_to_y_divisor)
